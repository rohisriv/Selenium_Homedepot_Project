...
import hdPallavi.PageObjects.DIYProjectListPageObj;
import hdPallavi.Utilities.ReadTxtFile;
...
public class DIYProjectTC extends BaseClassHomeDepot{
    ...
    public void setUpMethod(String browser) throws Exception {
       ...
       System.out.println("DIYProjectTC setUpMethod called ");
        try{
            datadiylistheader = ReadTxtFile.txtFileread("C:\\Users\\rohin\\neweclipse-workspace\\HomeDepotProject_ALL_Combined\\src\\test\\java\\hdPallavi\\TestData\\diylistheader.txt");
        ...
        try{
            datadiylistoptions = ReadTxtFile.txtFileread("C:\\Users\\rohin\\neweclipse-workspace\\HomeDepotProject_ALL_Combined\\src\\test\\java\\hdPallavi\\TestData\\diylistoptions.txt");
            System.out.println("File read and write complete");
        ...
        try{
            datadiypageheading = ReadTxtFile.txtFileread("C:\\Users\\rohin\\neweclipse-workspace\\HomeDepotProject_ALL_Combined\\src\\test\\java\\hdPallavi\\TestData\\diypageheading.txt");
            System.out.println("File read and write complete");
